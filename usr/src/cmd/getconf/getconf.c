...
#define	CONFSTR_VAR(x)	_CS_ ## x, #x, CONFSTR, NOFLAGS
#define	CONFSTR_XBS(x)	CONFSTR_VAR(x), _CS_ ## x, "_" #x, CONFSTR, NOFLAGS
 ...
 */
	...
	CONFSTR_VAR(LFS_CFLAGS),
	CONFSTR_VAR(LFS_LDFLAGS),
	CONFSTR_VAR(LFS_LIBS),
	CONFSTR_VAR(LFS_LINTFLAGS),

	/* transitional large file interface configuration */

	CONFSTR_VAR(LFS64_CFLAGS),
	CONFSTR_VAR(LFS64_LDFLAGS),
	CONFSTR_VAR(LFS64_LIBS),
	CONFSTR_VAR(LFS64_LINTFLAGS),
	 ...
	 */
	CONFSTR_XBS(XBS5_ILP32_OFF32_CFLAGS),
	CONFSTR_XBS(XBS5_ILP32_OFF32_LDFLAGS),
	CONFSTR_XBS(XBS5_ILP32_OFF32_LIBS),
	CONFSTR_XBS(XBS5_ILP32_OFF32_LINTFLAGS),
	CONFSTR_XBS(XBS5_ILP32_OFFBIG_CFLAGS),
	CONFSTR_XBS(XBS5_ILP32_OFFBIG_LDFLAGS),
	CONFSTR_XBS(XBS5_ILP32_OFFBIG_LIBS),
	CONFSTR_XBS(XBS5_ILP32_OFFBIG_LINTFLAGS),
	CONFSTR_XBS(XBS5_LP64_OFF64_CFLAGS),
	CONFSTR_XBS(XBS5_LP64_OFF64_LDFLAGS),
	CONFSTR_XBS(XBS5_LP64_OFF64_LIBS),
	CONFSTR_XBS(XBS5_LP64_OFF64_LINTFLAGS),
	CONFSTR_XBS(XBS5_LPBIG_OFFBIG_CFLAGS),
	CONFSTR_XBS(XBS5_LPBIG_OFFBIG_LDFLAGS),
	CONFSTR_XBS(XBS5_LPBIG_OFFBIG_LIBS),
	CONFSTR_XBS(XBS5_LPBIG_OFFBIG_LINTFLAGS),
	...
	/*
	 * UNIX 08 confstr() additions for compilation environments
	 */
	...
	/* End of UNIX 08 compilation environments */
